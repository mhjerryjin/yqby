...
function processOtherEvent(res, req, eventKey, from, to) {
	...
	var resData = '<xml><ToUserName><![CDATA[' + from + ']]></ToUserName><FromUserName><![CDATA[' + to + ']]></FromUserName><CreateTime>' + timestamp + '</CreateTime><MsgType><![CDATA[text]]></MsgType><Content><![CDATA[欢迎使用有求必应]]></Content></xml>';
	switch (eventKey) {
