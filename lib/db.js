...
var getUser = exports.getUser = function (userid, callback) {
	redisClient.hget(config.redis.storage.mainUserkey, userid, function (err, user) {
		if (err || common.IsNullOrEmpty(user)) return callback(null);
...
/*完成需求*/
// var finishQuestion = exports.finishQuestion = function(userid, callback){
// 	getUser(userid, function(user){
// 		var quesid = user.assigned;
// 		user.assigned = ''
// 	});
// }